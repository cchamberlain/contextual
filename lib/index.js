...
function contextual() {
                                    ...
                                    var getTheme = (0, _theme2.default)({ defaultTheme: defaultTheme, overrideTheme: overrideTheme });
                                    _chai.assert.ok(contextTypes, 'contextTypes could not be generated');
                                    _chai.assert.ok(getTheme, 'getTheme could not be generated');
                                    return { contextTypes: contextTypes, getTheme: getTheme, schemeNames: _scheme.schemeNames };
}